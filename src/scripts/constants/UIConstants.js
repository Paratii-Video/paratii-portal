...
export const CONTROLS_HEIGHT: string = '44px'
export const CONTROLS_HEIGHT_TABLET: string = '32px'
...
export const CONTROLS_SPACING: string = '20px'
export const CONTROLS_SPACING_MOBILE: string = '10px'
